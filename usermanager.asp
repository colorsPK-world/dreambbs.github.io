...
Function friendlist()
	...
	For i=0 To Ubound(SQL,2)
		...
		End If
		friendlist=friendlist & "<a href=""javascript:;"" onclick=""DvWnd.open('给"&F_friend&"发送短信','messanger.asp?action=new&amp;touser="&F_friend&"',800,600,1,{bgc:'black',opa:0.5});""><img src="""&Dvbbs.mainpic(15)&""" alt='发短信' border=0></a>&nbsp;<a href=dispuser.asp?name="&F_friend&" >"&F_friend&"</a> "&OnlineTime&" <br>"
	Next
End Function
